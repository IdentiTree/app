...
const COLOR_PRIMARY_LIGHTER = '#CCF9F1'
const COLOR_PRIMARY_LIGHT = '#66ECD6'
const COLOR_PRIMARY_MAIN = '#00E0BA'
const COLOR_PRIMARY_DARK = '#089386'
const COLOR_PRIMARY_DARKER = '#0F4651'
